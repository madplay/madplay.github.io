...
**먼저, 클래스 로딩 시점에 객체를 미리 생성하는 방법입니다.**<br/>
...
**다음은 getInstance() 메서드를 동기화시키는 방법입니다.**<br/>
...
**또 다른 방법은 DCL(Double-Checking Locking)을 사용하는 방법입니다.**<br/>
...
<br/>
**마지막으로 많이 생소할 수 있는 enum을 사용하는 방법이 있습니다.**<br/> 
