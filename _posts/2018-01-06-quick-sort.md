...
# 퀵 정렬 진행
진행 규칙은 간단합니다. high는 pivot 보다 작은 값을 찾고 반대로 low는 pivot 보다 큰 값을 찾습니다.
...
< 교환 1회 진행 > 후의 모습입니다. high가 찾은 < 요소 2 >와 low가 찾은 < 요소 9 >가 교환되었습니다.
...
<div class="post_caption">"이런 상황에서는 pivot과 high가 가리키는 값을 바꾸게 됩니다."</div> 
...
# pivot의 위치에 대해서
이번 포스팅에서 진행한 것처럼 가장 왼쪽에 있는 요소를 pivot으로 지정하는 경우 불균등하게 나뉠 수 있는 이슈가 있습니다. 예제와 다르게 pivot이 중간에
...
3개씩의 요소들로 나뉘어 총 8개의 영역으로 구분되며 최종적으로는 1개씩 나뉘어 총 16개의 영역으로 구분됩니다.
